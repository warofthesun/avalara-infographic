...
//  $$ |  $$ |$$ |  $$ |$$ |  $$\ $$ |  $$ |$$ |\$$$ |   $$ |   $$ |      $$ |  $$ |$$ |  $$ |
//  $$ |  $$ |$$ |  $$ |\$$$$$$  | $$$$$$  |$$ | \$$ |   $$ |   $$$$$$$$\ \$$$$$$  |$$ |  $$ |
//  \__|  \__|\__|  \__| \______/  \______/ \__|  \__|   \__|   \________| \______/ \__|  \__|
//   $$$$$$\  $$$$$$$\   $$$$$$\  $$$$$$$\  $$\   $$\ $$$$$$\  $$$$$$\   $$$$$$\
...
// Licensed under the Apache License, Version 2.0 (the "License");ex
...
function main() {
  ...
  var defaultSettings = {
    ...
    fonts: [
      {
        aifont: "Apertura-Regular",
        family: "'Apertura',sans-serif",
		weight: "400"
      },
		
	  {
        aifont: "Apertura-Bold",
        family: "'Apertura',sans-serif",
		weight: "700"
      },
		{
        aifont: "Apertura-Black",
        family: "'Apertura',sans-serif",
		weight: "800"
      },
    ],
    ...
    config_file: ["headline", "leadin", "summary", "notes", "source", "credit"],
  ...
  function showCompletionAlert(showPrompt) {
    ...
    if (errors.length > 0) {
      ...
      alertHed = "The Script Was Unable to Finish"; // &rsquo;
    } else {
      alertHed = "";
    }
    ...
    if (showPrompt) {
      ...
      alertText += rule + "Raconteur x TechnologyAdvice";
  ...
  function deriveTextStyleCss(frameData) {
    ...
    var defaultCssStyle = {
      ...
      "font-style": "normal",
      height: "auto",
      position: "relative", // 'relative' also used (to correct baseline misalignment)
    };
    var defaultAiStyle = {
  ...
  function generateOutputHtml(content, pageName, settings) {
    ...
    function subHeadCheck(subheadText) {
      if (subheadText === "") {
        return '<span id="graphicSubtitle"></span>\r';
      } else {
        return '<br><span id="graphicSubtitle">' + subheadText + "</span>\r";
      }
    }
	  
    // START HTML RACONTEUR`
    commentBlock = '<html lang="en">\r';
    commentBlock += "<head>\r";
    commentBlock += '\t<meta charset="utf-8">\r';
    commentBlock += '\t<meta name="viewport" content="width=device-width">\r';
	commentBlock += '\t<link rel="stylesheet" href="https://use.typekit.net/gqp0uak.css">\r';
	commentBlock += '\t<link rel="stylesheet" href="../../css/animations.css">\r';
	commentBlock += '\t<link rel="stylesheet" href="../../css/style.css">\r';
    commentBlock += "</head>\r";
    commentBlock += "<body>\r";
    commentBlock += '<div id="graphic">\r';
    html = '<div id="' + containerId + '" class="ai2html">\r';
    commentBlock += '<h1 id="graphicTop">\r';
    commentBlock +=
      '\t\t<span id="graphicTitle">' + docSettings.headline + "</span>";
    commentBlock += "</h1>\r";
    html = '<div id="' + containerId + '" class="ai2html">\r';
    commentBlock += '<h2 id="graphicSub">\r';
    commentBlock +=
      '\t\t<span id="graphicSubtitle">' + docSettings.sub_headline + "</span>";
    commentBlock += "</h2>\r";
    ...
    // CSS
    css =
      '<style type="text/css" media="screen,print">\r' +
    ...
    // SOURCE
    function notesSourceJoin(noteText, sourceText) {
      if (noteText === "") {
        if (sourceText === "") {
          return "";
        } else {
    ...
    html +=
      '\t<p id="graphicSource">' +
      docSettings.notes +
      notesSourceJoin(docSettings.notes, docSettings.source) +
      docSettings.source;
    +"</p>\r";
    ...
    commentBlock += '<h3 id="graphicBottom">\r';
    commentBlock +=
      '\t\t<span id="graphicEnd">' + docSettings.headline + "</span>";
    commentBlock += "</h3>\r";
